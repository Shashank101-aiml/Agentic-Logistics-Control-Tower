  ...
  return (
    <div 
      ...
      style={{ 
        ...
        background: isHigh ? 'rgba(255, 51, 102, 0.05)' : 'rgba(255, 255, 255, 0.03)',
    ...
    >
      <div className="agent-info">
        <div 
          ...
          style={{ 
            background: isHigh ? 'rgba(255, 51, 102, 0.15)' : 'rgba(0, 242, 255, 0.1)',
            width: '44px',
            height: '44px'
          }}
        >
        ...
        <div>
          <div className="agent-name" style={{ fontSize: '1.05rem', color: '#ffffff' }}>
            {event.event_type}
          </div>
