    ...
    <div className="glass-panel" style={{ padding: '24px' }}>
      <div className="section-header">
        ...
        <div style={{ display: 'flex', gap: '16px', fontSize: '0.85rem' }}>
          <span style={{ display: 'flex', alignItems: 'center', gap: '6px', color: 'var(--text-muted)' }}>
            <span style={{ width: '12px', height: '12px', background: 'rgba(255,255,255,0.2)', borderRadius: '3px', display: 'inline-block' }}></span>
            Corridor Alpha (Direct)
          </span>
          <span style={{ display: 'flex', alignItems: 'center', gap: '6px', color: 'var(--accent-cyan)', fontWeight: 700 }}>
            <span style={{ width: '12px', height: '12px', background: 'var(--accent-cyan)', borderRadius: '3px', display: 'inline-block', boxShadow: '0 0 8px var(--accent-cyan)' }}></span>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginTop: '24px' }}>
        {metrics.map((m, idx) => {
          ...
          return (
            <div key={idx} style={{ background: 'rgba(0,0,0,0.2)', padding: '14px 18px', borderRadius: '12px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.95rem', fontWeight: 600, color: '#fff', marginBottom: '12px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
                ...
                <div style={{ flex: 1, height: '10px', background: 'rgba(255,255,255,0.05)', borderRadius: '5px', overflow: 'hidden' }}>
                  <div style={{ width: `${stdPct}%`, height: '100%', background: 'rgba(255,255,255,0.3)', borderRadius: '5px' }} />
                </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div style={{ flex: 1, height: '12px', background: 'rgba(0, 242, 255, 0.1)', borderRadius: '6px', overflow: 'hidden' }}>
                  <div style={{ 
                    width: `${aiPct}%`, 
                    height: '100%', 
