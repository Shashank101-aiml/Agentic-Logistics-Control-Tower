            ...
            >
              ...
              <div style={{ width: '32px', height: '100%', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', position: 'relative' }}>
                ...
                <div style={{
                  ...
                  background: isHovered ? 'var(--accent-cyan)' : 'rgba(0, 242, 255, 0.35)',
                ...
                <div style={{
                  ...
                  position: 'absolute',
                  bottom: 0,
                  boxShadow: h.highSev > 0 ? '0 0 10px rgba(255, 51, 102, 0.5)' : 'none'
                }} />
              </div>

              <span style={{ fontSize: '0.75rem', color: isHovered ? '#fff' : 'var(--text-muted)', marginTop: '10px', fontWeight: isHovered ? 700 : 400 }}>
                {h.time}
              </span>
            </div>
          );
