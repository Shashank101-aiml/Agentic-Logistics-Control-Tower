    ...
    <div className="agent-item" style={{ transition: 'all 0.2s ease', cursor: 'default' }}>
      <div className="agent-info">
        <div 
          ...
          style={{ 
            background: isOnline ? 'rgba(0, 242, 255, 0.12)' : 'rgba(255, 51, 102, 0.12)',
      ...
      <div style={{ textAlign: 'right' }}>
        <div className="status-badge" style={{ 
          padding: '4px 10px', 
          fontSize: '0.75rem',
          background: isOnline ? 'rgba(0, 229, 153, 0.12)' : 'rgba(255, 51, 102, 0.12)',
          borderColor: isOnline ? 'rgba(0, 229, 153, 0.3)' : 'rgba(255, 51, 102, 0.3)',
          ...
          <div className="pulse-dot" style={{ 
            ...
            boxShadow: `0 0 8px ${isOnline ? 'var(--accent-emerald)' : 'var(--accent-rose)'}`
          }}></div>
          {agent?.status || 'ONLINE'}
        </div>
