...
export default function RouteCard({ corridor, isSelected, onSelect }) {
  ...
  return (
    <div 
      ...
      style={{ 
        cursor: 'pointer',
        borderColor: isSelected ? 'var(--accent-cyan)' : isSafe ? 'rgba(0, 229, 153, 0.3)' : 'var(--border-subtle)',
        background: isSelected ? 'rgba(0, 242, 255, 0.08)' : 'var(--bg-panel)',
        boxShadow: isSelected ? '0 0 24px rgba(0, 242, 255, 0.25)' : 'none',
    ...
    >
      ...
      <div style={{ 
        ...
        <span className="status-badge" style={{ 
          background: isSafe ? 'rgba(0, 229, 153, 0.15)' : 'rgba(255, 51, 102, 0.15)',
