    ...
    <div className="page-wrapper">
      ...
      {loading && corridors.length === 0 ? (
        ...
        <>
          ...
          {primary && (
            <div className="workflow-box" style={{ marginBottom: '28px', background: 'rgba(0, 184, 255, 0.1)', border: '1px solid var(--accent-cyan)' }}>
              ...
              <p style={{ fontSize: '1.05rem', color: '#fff', margin: '10px 0', lineHeight: 1.5 }}>
                {primary.primary_recommendation}
              </p>
              <div style={{ display: 'flex', gap: '20px', marginTop: '14px', fontSize: '0.85rem', color: 'var(--text-muted)' }}>
                <span>Analysis Timestamp: <strong style={{ color: '#fff' }}>{primary.timestamp}</strong></span>
            ...
            {adoptedCorridor && (
              <div style={{ 
                ...
                <button 
                  ...
                  style={{ background: 'var(--accent-emerald)', color: '#060b14', padding: '10px 20px' }}
