    ...
    <div className="page-wrapper">
      <div className="section-header" style={{ marginBottom: '24px' }}>
        ...
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
          <div style={{ display: 'flex', background: 'rgba(0,0,0,0.4)', border: '1px solid var(--border-subtle)', borderRadius: '10px', padding: '4px' }}>
            {['ALL', 'HIGH', 'MEDIUM', 'LOW'].map(sev => (
              <button
                ...
                style={{
                  ...
                  color: filterSeverity === sev ? '#060b14' : 'var(--text-muted)',
                  border: 'none',
                  padding: '6px 14px',
                  borderRadius: '6px',
                  fontWeight: 600,
      ...
      <div className="glass-panel" style={{ padding: '24px' }}>
        <div className="section-header" style={{ marginBottom: '16px' }}>
          ...
          {highSeverityCount > 0 && (
            <span className="status-badge" style={{ background: 'rgba(255, 51, 102, 0.15)', borderColor: 'var(--accent-rose)', color: 'var(--accent-rose)' }}>
