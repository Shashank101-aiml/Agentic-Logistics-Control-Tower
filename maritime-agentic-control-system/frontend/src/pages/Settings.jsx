      ...
      <div className="section-header" style={{ marginBottom: '28px' }}>
        <div>
          ...
          <p style={{ color: 'var(--text-muted)', marginTop: '4px' }}>
            Adjust telemetry streaming rates, autonomous LangGraph thresholds, and backend API connections.
          </p>
        </div>
      ...
      <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <div className="glass-panel" style={{ padding: '24px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '16px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'rgba(0,0,0,0.25)', padding: '14px 18px', borderRadius: '10px' }}>
              <div>
                <div style={{ fontWeight: 600, color: '#fff' }}>Autonomous Simulation Fallback Mode</div>
                <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginTop: '2px' }}>
                  Automatically generate realistic telemetry and LangGraph AI reasoning if local FastAPI backend goes offline.
                </div>
              </div>
              <input 
                type="checkbox" 
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
            <div>
              <label style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.85rem', color: 'var(--text-muted)', marginBottom: '8px' }}>
                ...
                <strong style={{ color: '#fff' }}>{pollingInterval}s</strong>
              </label>
              <input 
                type="range" 
                min="5" 
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'rgba(0,0,0,0.25)', padding: '14px 18px', borderRadius: '10px' }}>
              <div>
                <div style={{ fontWeight: 600, color: '#fff' }}>Autonomous Waypoint Rerouting (Route Optimization Agent)</div>
                <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginTop: '2px' }}>
        ...
        <div className="glass-panel" style={{ padding: '24px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'rgba(0,0,0,0.25)', padding: '14px 18px', borderRadius: '10px' }}>
            <div>
              <div style={{ fontWeight: 600, color: '#fff' }}>Audio Alarm on Critical Hazard Ingestion</div>
              <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginTop: '2px' }}>
